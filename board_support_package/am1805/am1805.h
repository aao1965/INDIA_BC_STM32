...
#define AM1805_KEY_CONF          0x9D // Для регистров BREF, CAL_XT, BATMODE_IO
...
// Инициализация аппаратной части (Только базовые настройки, БЕЗ калибровки)
bool          AM1805_Init_Smart(I2C_HandleTypeDef *hi2c_ptr, osMutexId_t mutex_id);

// Полный сброс чипа (эквивалент извлечения батарейки)
